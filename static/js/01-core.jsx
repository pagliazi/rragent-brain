...
// Migrate localStorage keys from openclaw to rragent
(function() {
  const migrations = [
    ['openclaw_token', 'rragent_token'],
    ['openclaw_convs_v2', 'rragent_convs_v2'],
    ['openclaw_active_conv', 'rragent_active_conv'],
  ];
